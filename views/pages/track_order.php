...
<head>
    ...
    <title>Track Order - KWRmart</title>
    ...
    <div class="flex-grow pt-32 pb-16 relative">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div class="w-20 h-20 mx-auto rounded-2xl bg-slate-800/80 flex items-center justify-center shadow-lg border border-slate-700/50 mb-8">
                <i class="fa-solid fa-truck-fast text-3xl text-indigo-400"></i>
            </div>
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-6">Track Order</h1>
            <p class="text-slate-400 text-lg mb-12">Track your recent KWRmart orders.</p>
            ...
            <div class="glass-panel p-8 rounded-2xl text-left border border-slate-700/50 shadow-xl">
                <div class="space-y-6 text-slate-300 leading-relaxed">
                    <p>Welcome to the Track Order page. This section is currently under development.</p>
